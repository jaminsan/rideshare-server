...
lazy val rideshareApi = (project in file("rideshareApi"))
...
lazy val functionalTest = (project in file("functionalTest"))
  .settings(commonSettings: _*)
  .settings(
    organization := "com.example",
    ...
    version := "0.0.1-SNAPSHOT",
    scalaVersion := "2.12.8",
    libraryDependencies ++= Seq("com.github.agourlay" %% "cornichon-test-framework" % "0.16.3" % Test),
