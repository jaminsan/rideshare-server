...
case class PickingUp(
  ...
  id:        Option[Long] = None)
  extends Schedule(duration, location, vehicleId, tripId, done, id)
...
//case class PickUpShareMate(location: Location, duration: Duration, tripId: Long) extends Schedule(duration, location, tripId: Long)
//
//case class DropOffShareMate(location: Location, duration: Duration, tripId: Long) extends Schedule(duration, location, tripId: Long)
